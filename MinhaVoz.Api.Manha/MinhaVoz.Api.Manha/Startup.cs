...
namespace MinhaVoz.Api.Manha
{
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			{
				c.SwaggerDoc("v1", new Info { Title = "MinhaVoz API", Version = "v1" });
			});
			...
			).AddJwtBearer("JwtBearer", options =>
			{
				...
				options.TokenValidationParameters = new TokenValidationParameters
				{
					...
					IssuerSigningKey = new SymmetricSecurityKey(System.Text.Encoding.UTF8.GetBytes("MinhaVoz-chave-autenticacao")),
					//Tempo de expiração do Token
					ClockSkew = TimeSpan.FromMinutes(30),
					//Nome da Issuer, de onde esta vindo
					ValidIssuer = "MinhaVoz.WebApi",
					//Nome da Audience, de onde esta vindo
					ValidAudience = "MinhaVoz.WebApi"
				};
			});
		}
		...
		public void Configure(IApplicationBuilder app, IHostingEnvironment env)
		{
			...
			app.UseSwaggerUI(c =>
			{
				c.SwaggerEndpoint("/swagger/v1/swagger.json", "MinhaVoz");
			});
